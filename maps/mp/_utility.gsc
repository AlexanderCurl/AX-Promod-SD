...
load_hardpointinformations()
{
        wait .5;
        level.needetkills_nuke_mp = getDvarint("scr_killstreak_kills_nuke_mp");
        level.needetkills_deserteagle_mp = getDvarint("scr_killstreak_kills_deserteagle_mp");
        if(!isDefined(level.needetkills_nuke_mp))
        {
                level.needetkills_nuke_mp = 0;
        }
        if(!isDefined(level.needetkills_deserteagle_mp))
        {
                level.needetkills_deserteagle_mp = 0;
        }
}
